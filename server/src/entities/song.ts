/**
 * Represents a song entity in the music database
 * This interface defines the structure for song data throughout the application
 */
export interface Song {
  /** 
   * Unique identifier for the song
   * Used as primary key in database operations and API responses
   */
  id: number;
